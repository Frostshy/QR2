...
$sql_search = "";
if($search) $sql_search = "AND `created_date` = '$search' ";
?>
<!DOCTYPE html>
<html>
...
<div class="w3-container " id="contact">
    <div class="w3-content w3-containerx " style="max-width:600px">	
		...
		<?PHP
		$bil = 0;
		$SQL_list = "SELECT * FROM `attendance`,`class`,`subject` WHERE attendance.id_class = class.id_class AND class.id_subject = subject.id_subject AND attendance.id_student = $id_student $sql_search";
...
<div class="w3-bottom w3-card w3-white w3-padding-small" style="z-index=-10"> 
	<div class="w3-row w3-center">
		...
		<a class="w3-col s3 w3-button" href="history.php">
			<i class="fa fa-calendar-check fa-2x w3-text-red"></i><br>History
		</a>
